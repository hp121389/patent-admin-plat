...
// @Router /api/v1/user-agent/{patent_id} [get]
// @Security Bearer
...
// @Tags 专利表
// @Param PatentId query string false "专利ID"
// @Router /api/v1/user-agent/{patent_id} [delete]
// @Security Bearer
...
// @Router /api/v1/user-agent/{patent_id}/claim [post]
// @Security Bearer
...
// @Accept  application/json
// @Product application/json
// @Router /api/v1/user-agent/{patent_id}/focus [post]
// @Security Bearer
