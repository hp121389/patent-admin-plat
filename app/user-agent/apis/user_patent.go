...
// @Description 获取认领关系
// @Tags 用户专利关系表
// @Router /api/v1/user-user-agent/claim [get]
// @Security Bearer
...
// @Description 获取关注关系
// @Tags 用户专利关系表
// @Router /api/v1/user-user-agent/collection [get]
// @Security Bearer
...
//// @Router /api/v1/user-user-agent/ [post]
//// @Security Bearer
...
// @Router /api/v1/user-user-agent/{patent_id}/{type} [delete]
// @Security Bearer
...
// @Router /api/v1/user-user-agent [put]
// @Security Bearer
